...
namespace ZLGCANAPI
{
    ...
    public class ZLGCAN
    {
        ...
        #region 设备类型
        public static uint ZCAN_PCI9810 = 2;
        public static uint ZCAN_USBCAN1 = 3;
        public static uint ZCAN_USBCAN2 = 4;
        public static uint ZCAN_PCI9820 = 5;
        public static uint ZCAN_CANETUDP = 12;
        public static uint ZCAN_PCI9840 = 14;
        public static uint ZCAN_PCI9820I = 16;
        public static uint ZCAN_CANETTCP = 17;
        public static uint ZCAN_PCI5010U = 19;
        public static uint ZCAN_USBCAN_E_U = 20;
        public static uint ZCAN_USBCAN_2E_U = 21;
        public static uint ZCAN_PCI5020U = 22;
        public static uint ZCAN_PCIE9221 = 24;
        public static uint ZCAN_WIFICAN_TCP = 25;
        public static uint ZCAN_WIFICAN_UDP = 26;
        public static uint ZCAN_PCIe9120 = 27;
        public static uint ZCAN_PCIe9110 = 28;
        public static uint ZCAN_PCIe9140 = 29;
        public static uint ZCAN_USBCAN_4E_U = 31;
        public static uint ZCAN_CANDTU_200UR = 32;
        public static uint ZCAN_USBCAN_8E_U = 34;
        public static uint ZCAN_CANDTU_NET = 36;
        public static uint ZCAN_CANDTU_100UR = 37;
        public static uint ZCAN_PCIE_CANFD_200U = 39;
        public static uint ZCAN_PCIE_CANFD_400U = 40;
        public static uint ZCAN_USBCANFD_200U = 41;
        public static uint ZCAN_USBCANFD_100U = 42;
        public static uint ZCAN_USBCANFD_MINI = 43;
        public static uint ZCAN_CANSCOPE = 45;
        public static uint ZCAN_CLOUD = 46;
        public static uint ZCAN_CANDTU_NET_400 = 47;
        public static uint ZCAN_CANFDNET_TCP = 48;
        public static uint ZCAN_CANFDNET_200U_TCP = 48;
        public static uint ZCAN_CANFDNET_UDP = 49;
        public static uint ZCAN_CANFDNET_200U_UDP = 49;
        public static uint ZCAN_CANFDWIFI_TCP = 50;
        public static uint ZCAN_CANFDWIFI_100U_TCP = 50;
        public static uint ZCAN_CANFDWIFI_UDP = 51;
        public static uint ZCAN_CANFDWIFI_100U_UDP = 51;
        public static uint ZCAN_CANFDNET_400U_TCP = 52;
        public static uint ZCAN_CANFDNET_400U_UDP = 53;
        public static uint ZCAN_CANFDNET_100U_TCP = 55;
        public static uint ZCAN_CANFDNET_100U_UDP = 56;
        public static uint ZCAN_CANFDNET_800U_TCP = 57;
        public static uint ZCAN_CANFDNET_800U_UDP = 58;
        public static uint ZCAN_USBCANFD_800U = 59;
        public static uint ZCAN_PCIE_CANFD_100U_EX = 60;
        public static uint ZCAN_PCIE_CANFD_400U_EX = 61;
        public static uint ZCAN_PCIE_CANFD_200U_MINI = 62;
        public static uint ZCAN_PCIE_CANFD_200U_EX = 63;
        public static uint ZCAN_PCIE_CANFD_200U_M2 = 63;
        public static uint ZCAN_CANFDDTU_400_TCP = 64;
        public static uint ZCAN_CANFDDTU_400_UDP = 65;
        public static uint ZCAN_CANFDWIFI_200U_TCP = 66;
        public static uint ZCAN_CANFDWIFI_200U_UDP = 67;
        public static uint ZCAN_CANFDDTU_800ER_TCP = 68;
        public static uint ZCAN_CANFDDTU_800ER_UDP = 69;
        public static uint ZCAN_CANFDDTU_800EWGR_TCP = 70;
        public static uint ZCAN_CANFDDTU_800EWGR_UDP = 71;
        public static uint ZCAN_CANFDDTU_600EWGR_TCP = 72;
        public static uint ZCAN_CANFDDTU_600EWGR_UDP = 73;
        public static uint ZCAN_CANFDDTU_CASCADE_TCP = 74;
        public static uint ZCAN_CANFDDTU_CASCADE_UDP = 75;
        public static uint ZCAN_USBCANFD_400U = 76;
        public static uint ZCAN_CANFDDTU_200U = 77;
        public static uint ZCAN_ZPSCANFD_TCP = 78;
        public static uint ZCAN_ZPSCANFD_USB = 79;
        public static uint ZCAN_CANFDBRIDGE_PLUS = 80;
        public static uint ZCAN_CANFDDTU_300U = 81;
        public static uint ZCAN_PCIE_CANFD_800U = 82;
        public static uint ZCAN_PCIE_CANFD_1200U = 83;
        public static uint ZCAN_MINI_PCIE_CANFD = 84;
        public static uint ZCAN_USBCANFD_800H = 85;
        #endregion

        #region LIN事件
        public static uint ZCAN_LIN_WAKE_UP = 1;
        public static uint ZCAN_LIN_ENTERED_SLEEP_MODE = 2;
        public static uint ZCAN_LIN_EXITED_SLEEP_MODE = 3;
        #endregion

        #region 函数
        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern nint ZCAN_OpenDevice(uint device_type, uint device_index, uint reserved);

        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern nint ZCAN_OpenDeviceByName(uint device_type, string name);

        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_CloseDevice(nint device_handle);

        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_IsDeviceOnLine(nint device_handle);

        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_GetDeviceInf(nint device_handle, nint pInfo);


        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern nint ZCAN_InitCAN(nint device_handle, uint can_index, nint pInitConfig);


        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern nint ZCAN_InitCAN(nint device_handle, uint can_index, ref ZCAN_CHANNEL_INIT_CONFIG config);


        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_StartCAN(nint chn_handle);


        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_ResetCAN(nint chn_handle);


        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_ClearBuffer(nint chn_handle);

        
        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_ReadChannelErrInfo(nint chn_handle, ref ZCAN_CHANNEL_ERR_INFO pErrInfo);


        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_GetReceiveNum(nint channel_handle, byte type);


        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_Transmit(nint channel_handle, nint pTransmit, uint len);


        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_TransmitFD(nint channel_handle, nint pTransmit, uint len);


        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_TransmitData(nint device_handle, nint pTransmit, uint len);


        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_Receive(nint channel_handle, nint pReceive, uint len, int wait_time = -1);


        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_ReceiveFD(nint channel_handle, nint pReceive, uint len, int wait_time = -1);


        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_ReceiveData(nint device_handle, nint pReceive, uint len, int wait_time);


        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_SetValue(nint device_handle, string path, string value);


        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_SetValue(nint device_handle, string path, nint value);


        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_SetValue(nint device_handle, string path, ref ZCAN_AUTO_TRANSMIT_OBJ value);

        
        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_SetValue(nint device_handle, string path, ref ZCANFD_AUTO_TRANSMIT_OBJ value);


        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern nint ZCAN_GetValue(nint device_handle, string path);



        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern nint ZCAN_InitLIN(nint device_handle, uint lin_index, nint pLINInitConfig);


        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_StartLIN(nint channel_handle);


        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_ResetLIN(nint channel_handle);


        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_TransmitLIN(nint channel_handle, nint pSend, uint Len);


        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_GetLINReceiveNum(nint channel_handle);


        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_ReceiveLIN(nint channel_handle, nint pReceive, uint Len, int WaitTime);


        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_SetLINPublish(nint channel_handle, nint pSend, uint nPublishCount);


        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_SetLINSubscribe(nint channel_handle, nint pSend, uint nSubscribeCount);


        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_WakeUpLIN(nint channel_handle);


        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_UDS_Request(nint device_handle, nint req, nint resp, nint dataBuf, uint dataBufSize);


        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_UDS_Control(nint device_handle, nint ctrl, nint resp);


        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_UDS_RequestEX(nint device_handle, nint requestData, nint resp, nint dataBuf, uint dataBufSize);


        [DllImport(".\\zlgcan.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZCAN_UDS_ControlEX(nint device_handle, uint dataType, nint ctrl, nint resp);
        #endregion
        ...
        {
            public ulong timeStamp;
            public uint flag;                                     // flag用于设置一些参数，内部结构可以通过以下函数实现设置和取值
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
        ...
        {
            public ulong timeStamp;        // 时间戳，单位微秒(us)
            public PID pid;                 // 受保护的ID
    ...
    public class ZDBC
    {
        ...
        // ZDBC.dll
        public delegate bool OnSend(nint ctx, nint pObj);
        public delegate void OnMultiTransDone(nint ctx, nint pMsg, nint data, ushort nLen, byte nDirection);
        ...
        [DllImport(".\\zdbc.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern bool ZDBC_LoadFile(uint DBCHandle, nint pFileInfo);
        ...
        /// <returns></returns>
        [DllImport(".\\zdbc.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern bool ZDBC_LoadContent(uint DBCHandle, nint pFileContent, uint merge);
        ...
        [DllImport(".\\zdbc.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern bool ZDBC_GetFirstMessage(uint DBCHandle, nint pMsg);
        ...
        /// <returns>true表示成功</returns>
        [DllImport(".\\zdbc.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern bool ZDBC_GetNextMessage(uint DBCHandle, nint pMsg);
        ...
        /// <returns></returns>
        [DllImport(".\\zdbc.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern bool ZDBC_GetMessageById(uint DBCHandle, uint nID, nint pMsg);
        ...
        [DllImport(".\\zdbc.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern bool ZDBC_Analyse(uint DBCHandle, nint pObj, nint pMsg);


        [DllImport(".\\zdbc.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern bool ZDBC_AsyncAnalyse(uint DBCHandle, nint pObj, uint frame_type, ulong extraData);


        [DllImport(".\\zdbc.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern void ZDBC_OnReceive(uint DBCHandle, nint pObj, uint frame_type);


        [DllImport(".\\zdbc.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern void ZDBC_SetSender(uint hDBC, OnSend sender, nint ctx);


        [DllImport(".\\zdbc.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern void ZDBC_SetOnMultiTransDoneFunc(uint hDBC, OnMultiTransDone func, nint ctx);


        [DllImport(".\\zdbc.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern byte ZDBC_Send(uint hDBC, nint pMsg);
        ...
        [DllImport(".\\zdbc.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern bool ZDBC_Decode(uint DBCHandle, nint P2DBCMessage, nint P2Obj, uint nCount, byte frame_type);
        ...
        /// <returns>是否成功。</returns>
        [DllImport(".\\zdbc.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern bool ZDBC_Encode(uint DBCHandle, nint P2Obj, nint P2nCount, nint pMsg, byte frame_type);
        ...
        /// <returns>实际值</returns>
        [DllImport(".\\zdbc.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern double ZDBC_CalcActualValue(nint sgl, nint rawVal); //原始值通过计算转为实际值,实际值会传入rawVal的地址
        ...
        /// <returns>原始值</returns>
        [DllImport(".\\zdbc.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern ulong ZDBC_CalcRawValue(nint sgl, nint actualVal);
        ...
        [DllImport(".\\zdbc.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZDBC_GetNetworkNodeCount(uint DBCHandle);
        ...
        /// <returns></returns>
        [DllImport(".\\zdbc.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern bool ZDBC_GetNetworkNodeAt(uint DBCHandle, uint index, nint node);
        ...
        /// <returns></returns>
        [DllImport(".\\zdbc.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern uint ZDBC_GetValDescPairCount(uint DBCHandle, uint mag_id, string signal_name);
        ...
        [DllImport(".\\zdbc.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern void ZDBC_GetValDescPair(uint DBCHandle, uint mag_id, string signal_name, nint pair);
        ...
        public struct DBCSignal
        {
            ...
            public uint multiplexer_value;    // 复用器开关值为此值时信号有效
    ...
    public class ZUDS
    {
        ...
        public delegate uint OnUDSTransmitDelegate(nint ctx, nint frame, uint count);
        ...
        public static extern uint ZUDS_Init(uint type);
        ...
        [DllImport(".\\zuds.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern void ZUDS_SetParam(uint ZUDS_HANDLE, byte type, nint param);
        ...
        [DllImport(".\\zuds.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern void ZUDS_SetTransmitHandler(uint ZUDS_HANDLE, nint ctx, OnUDSTransmitDelegate onUDSTransmit);


        [DllImport(".\\zuds.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern void ZUDS_OnReceive(uint ZUDS_HANDLE, nint ZUDS_FRAME);


        [DllImport(".\\zuds.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern void ZUDS_Request(uint ZUDS_HANDLE, nint ZUDS_REQUEST, nint ZUDS_RESPONSE);


        [DllImport(".\\zuds.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern void ZUDS_Stop(uint ZUDS_HANDLE);


        [DllImport(".\\zuds.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern void ZUDS_SetTesterPresent(uint ZUDS_HANDLE, byte enable, nint param);
        ...
        {
            public ushort timeout;// ms, timeout to wait the response of the server
            public ushort enhanced_timeout; // ms,timeout to wait after negative response: error code 0x78
            public uint reserved0; // 保留
            public uint reserved1; // 保留
        }
        ...
        public struct ZUDS_ISO15765_PARAM
        {
            ...
            public ushort fc_timeout; //接收流控超时时间(ms), 如发送首帧后需要等待回应流控帧。
        ...
        public struct ZUDS_TESTER_PRESENT_PARAM
        {
            ...
            public ushort cycle;//发送周期，单位毫秒；
            public byte suppress_response; // 1:suppress是否抑制响应，建议设置为 1；
            public uint reserved;//：保留，忽略即可。
        }
        ...
        public struct ZUDS_REQUEST
        {
            ...
            public nint param;              //array,params of the service 
        ...
        public struct ZUDS_positive
        {
            ...
            public nint param; // array, params of the service, don't free
        ...
        {
            public nint can_type;     // 0-CAN 1-CANFD 2-CANFD加速
            public nint chn_handle;   // 通道句柄
        }
        #endregion
    }
}
